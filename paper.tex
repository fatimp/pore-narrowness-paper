...
\section{Results}
We computed \highlight{awesomness} for 4000 synthetically generated images with
...
\begin{figure}
  ...
  \subfigure[\texttt{normal}]{
    \includegraphics[width=0.4\linewidth]{images/normal.png}}
  \subfigure[\texttt{thin}]{
    \includegraphics[width=0.4\linewidth]{images/thin.png}}
  \vskip\baselineskip
  \subfigure[\texttt{mnist}]{
    \includegraphics[width=0.4\linewidth]{images/mnist.png}}
  \subfigure[\texttt{mostlyconvex}]{
    \includegraphics[width=0.4\linewidth]{images/mostlyconvex.png}}
